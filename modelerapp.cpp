                              ...
                              const ModelerControl controls[], unsigned numControls)
{
	...
	m_ui->addControl("Azimuth",	  -20,  20, 0.1f,   3.14f);
	m_ui->addControl("Elevation", -1.6,  1.6, 0.1f,   0.5f);
	...
	m_ui->addControl("Near Clipping Plane",		1,  10,   1,    1);
	m_ui->addControl("Far Clipping Plane",	   10, 1000, 10,  100);
